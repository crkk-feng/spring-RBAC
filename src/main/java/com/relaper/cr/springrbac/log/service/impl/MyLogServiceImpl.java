package com.relaper.cr.springrbac.log.service.impl;

import cn.hutool.json.JSONObject;

import com.relaper.cr.springrbac.log.dao.LogDao;
...
public class MyLogServiceImpl implements MyLogService {
    ...
    public void save(String userName, String browser, String ip, ProceedingJoinPoint joinPoint, MyLog log) {
        ...
        com.relaper.cr.springrbac.log.aop.MyLog myLog = method.getAnnotation(com.relaper.cr.springrbac.log.aop.MyLog.class);
        // 方法路径
